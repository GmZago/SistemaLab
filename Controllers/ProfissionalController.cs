...
namespace SistemaExame.Controllers
{
    public class ProfissionalController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProfissionalId,ProfissionalNome,CargoId")] Profissional profissional)
        {
            ...
            ViewData["CargoId"] = new SelectList(_context.Cargo, "CargoId", "CargoId", profissional.CargoId);
            return View(profissional);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProfissionalId,ProfissionalNome,CargoId")] Profissional profissional)
        {
